...
class DisplayWeapon(DisplayMain):
    def __init__(self, root, main):
        ...
        self.Weapon = EntrySection(self.root, {"text":{"x":0, "text":"Weapon", "height":25}, "box":{"x":100, "width":100, "height":25}, "y":175})
...
class Display(object):
    def __init__(self):
        ...
        self.Weapons = Button(self.root, {"x":0, "y":25, "text":"Make Weapon", "func":self.MakeWeapon})
